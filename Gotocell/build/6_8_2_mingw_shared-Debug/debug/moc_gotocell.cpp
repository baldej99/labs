...
namespace {
struct qt_meta_tag_ZN8GotocellE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8GotocellE = QtMocHelpers::stringData(
    "Gotocell",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8GotocellE[] = {
...
Q_CONSTINIT const QMetaObject Gotocell::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8GotocellE.offsetsAndSizes,
    qt_meta_data_ZN8GotocellE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8GotocellE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<Gotocell *>(_o);
...
void *Gotocell::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8GotocellE.stringdata0))
